...
func TestServiceRegistry(t *testing.T) {
	...
	computeQuota := &corev1.ResourceQuota{
		...
		Spec: corev1.ResourceQuotaSpec{
			...
			Hard: corev1.ResourceList{
				corev1.ResourceLimitsCPU:      resource.MustParse("64000m"), // sandbox default is 20 or 20,000m - my cluster has 3 8000m core nodes
				corev1.ResourceLimitsMemory:   resource.MustParse("96Gi"),   // sandbox default is 64Gi, my cluster has 3 32 Gi nodes
