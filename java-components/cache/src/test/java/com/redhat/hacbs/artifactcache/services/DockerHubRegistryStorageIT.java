...
@Disabled
@QuarkusTest
@TestProfile(DockerHubRegistryStorageIT.DockerTestProfile.class)
public class DockerHubRegistryStorageIT {
    ...
    public static class DockerTestProfile implements QuarkusTestProfile {

        @Override
        public Map<String, String> getConfigOverrides() {
            return Map.of(
                    "store.rebuilt.registry", "docker.io",
                    "store.rebuilt.type", "oci_registry",
                    "store.rebuilt.owner", "phillipkruger");
        }
    }
