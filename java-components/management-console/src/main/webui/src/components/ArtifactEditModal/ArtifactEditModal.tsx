        ...
        {state == 'success' && <Form id="edit-artifact-scm-info-form">
          <FormGroup
            ...
            <Checkbox id="artifact-edit-group" name="artifact-edit-group"
                      ...
                      onChange={stateChange((s, v) => {s.group = v})}></Checkbox>
          </FormGroup>
          <FormGroup
            ...
            <Checkbox id="artifact-edit-version" name="artifact-edit-version"
                      ...
                      onChange={stateChange((s, v) => {s.version = v})}></Checkbox>
          </FormGroup>
    ...
    <>
          <FormGroup
            ...
            <TextInput
              ...
              value={data.repo.uri}
              onChange={stateChange((s, v) => {s.uri = v})}
            />
          </FormGroup>
          <FormGroup
            label="Path"
            ...
            <TextInput
              ...
              onChange={stateChange((s, v) => {s.path = v})}
            />
          </FormGroup>
