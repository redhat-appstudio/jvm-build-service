...
func (in *CredentialsStatus) DeepCopyInto(out *CredentialsStatus) {
	*out = *in
	if in.GenerationTimestamp != nil {
		in, out := &in.GenerationTimestamp, &out.GenerationTimestamp
		*out = (*in).DeepCopy()
	}
}
...
func (in *ImageCredentials) DeepCopyInto(out *ImageCredentials) {
	*out = *in
	if in.RegenerateToken != nil {
		in, out := &in.RegenerateToken, &out.RegenerateToken
		*out = new(bool)
		**out = **in
	}
