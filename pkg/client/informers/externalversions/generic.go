...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("jvmimagescans"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Jvmbuildservice().V1alpha1().JvmImageScans().Informer()}, nil
