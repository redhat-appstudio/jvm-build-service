...
var dependencybuildsResource = v1alpha1.SchemeGroupVersion.WithResource("dependencybuilds")

var dependencybuildsKind = v1alpha1.SchemeGroupVersion.WithKind("DependencyBuild")
