...
var dependencybuildsResource = schema.GroupVersionResource{Group: "jvmbuildservice.io", Version: "v1alpha1", Resource: "dependencybuilds"}

var dependencybuildsKind = schema.GroupVersionKind{Group: "jvmbuildservice.io", Version: "v1alpha1", Kind: "DependencyBuild"}
...
func (c *FakeDependencyBuilds) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DependencyBuild, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(dependencybuildsResource, c.ns, name), &v1alpha1.DependencyBuild{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.DependencyBuild), err
}

// List takes label and field selectors, and returns the list of DependencyBuilds that match those selectors.
func (c *FakeDependencyBuilds) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DependencyBuildList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(dependencybuildsResource, dependencybuildsKind, c.ns, opts), &v1alpha1.DependencyBuildList{})
	...
	list := &v1alpha1.DependencyBuildList{ListMeta: obj.(*v1alpha1.DependencyBuildList).ListMeta}
	for _, item := range obj.(*v1alpha1.DependencyBuildList).Items {
...
func (c *FakeDependencyBuilds) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(dependencybuildsResource, c.ns, opts))
...
func (c *FakeDependencyBuilds) Create(ctx context.Context, dependencyBuild *v1alpha1.DependencyBuild, opts v1.CreateOptions) (result *v1alpha1.DependencyBuild, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(dependencybuildsResource, c.ns, dependencyBuild), &v1alpha1.DependencyBuild{})
...
func (c *FakeDependencyBuilds) Update(ctx context.Context, dependencyBuild *v1alpha1.DependencyBuild, opts v1.UpdateOptions) (result *v1alpha1.DependencyBuild, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(dependencybuildsResource, c.ns, dependencyBuild), &v1alpha1.DependencyBuild{})
...
func (c *FakeDependencyBuilds) UpdateStatus(ctx context.Context, dependencyBuild *v1alpha1.DependencyBuild, opts v1.UpdateOptions) (*v1alpha1.DependencyBuild, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(dependencybuildsResource, "status", c.ns, dependencyBuild), &v1alpha1.DependencyBuild{})
...
func (c *FakeDependencyBuilds) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteActionWithOptions(dependencybuildsResource, c.ns, name, opts), &v1alpha1.DependencyBuild{})
...
func (c *FakeDependencyBuilds) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(dependencybuildsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.DependencyBuildList{})
	return err
}
...
func (c *FakeDependencyBuilds) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DependencyBuild, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(dependencybuildsResource, c.ns, name, pt, data, subresources...), &v1alpha1.DependencyBuild{})
