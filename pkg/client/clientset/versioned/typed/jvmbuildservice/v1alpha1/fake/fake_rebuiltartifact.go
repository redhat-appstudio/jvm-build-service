...
var rebuiltartifactsResource = v1alpha1.SchemeGroupVersion.WithResource("rebuiltartifacts")

var rebuiltartifactsKind = v1alpha1.SchemeGroupVersion.WithKind("RebuiltArtifact")
