...
var jvmimagescansResource = v1alpha1.SchemeGroupVersion.WithResource("jvmimagescans")

var jvmimagescansKind = v1alpha1.SchemeGroupVersion.WithKind("JvmImageScan")
