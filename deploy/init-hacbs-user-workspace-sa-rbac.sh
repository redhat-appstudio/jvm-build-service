...
KUBECONFIG=$COMPUTE_KUBECONFIG helm install --set kcpNamespace=$HACBS_WORKSPACE_NAMESPACE $DIR/kcp-hacbs-workspace-compute-cluster-rbac --debug --generate-name
