...
This is currently using link:https://docs.openshift.com/pipelines/1.13/about/op-release-notes.html[OpenShift Pipelines 1.13]
...
| JBS_HERMETIC_BUILDS | Set to 'Required' to enable hermetic builds
